...
namespace HamuaRegistrationApi.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class DataVisualisationController : ControllerBase
    {
        ...
        public DataVisualisationController(ILogger<Tangata> logger, ITangataService service, IMapper mapper)
        {
            _logger = logger;
        ...
        //[HttpGet("residence/town")]
        //public async Task<IActionResult> GetResidencyCityData()
        //{
        //    var ngaTangata = await tangataService.GetAllTangataAsync();

        //    var languageGroups = ngaTangata.GroupBy(x => x.City);
