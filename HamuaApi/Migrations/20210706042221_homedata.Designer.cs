...
namespace HamuaRegistrationApi.Migrations
{
    ...
    [Migration("20210706042221_homedata")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HamuaRegistrationApi.DAL.Models.Tangata", b =>
                {
                    ...
                    b.Property<bool>("KeepMeNotified")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ReturnToRuatokiToLive")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HamuaRegistrationApi.DAL.Models.Tupuna", b =>
                {
                    b.Property<int>("TupunaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("PrimaryHapu")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PrimaryIwi")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Relationship")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("UriTangataId")
                        .HasColumnType("int");

                    b.HasKey("TupunaId");

                    b.HasIndex("UriTangataId");
            ...
            modelBuilder.Entity("HamuaRegistrationApi.DAL.Models.Tupuna", b =>
                {
                    b.HasOne("HamuaRegistrationApi.DAL.Models.Tangata", "Uri")
                        .WithMany("NgaTupuna")
                        .HasForeignKey("UriTangataId");
